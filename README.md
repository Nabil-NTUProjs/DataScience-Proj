...
1. [Data Extraction And Preparation with Analysis](https://github.com/Note06/DataScience-Proj/blob/main/1015-Proj%20EDA.ipynb)
...
![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.002.png)
...
For `arsenic`, **mode** for safe for Arsenic has **higher density percentage**, at a lower value(left skewed), compared to unsafe for Arsenic.<br> 
...
![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.004.png)

Therefore it can inferred that higher arsenic values might have correlation with the water being unsafe.

Similarly for `cadmium`, we can see that the **mode** of safe has a higher density percentages at a lower value, as compared to unsafe. Also the **boxplot** for safe is smaller than for unsafe, as we can see **boxplot** for cadmium (is\_safe==1) has its **Q3**  even smaller than the Q1 for **boxplot** for cadmium(is\_safe==0).

![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.005.png)
...
![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Picture1.png)
...
![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.006.png)
...
![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.009.png)
...
![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.010.png)
...
![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.012.png)
...
![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.014.png)![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.015.png)![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.016.png)
...
By reducing the dimension of a set of 3 features into a 2D plane, we can see that reduction of the 3 features into a 2D plane enables the features to be more well split, with the is\_safe==1 (red)values more to the left and the is\_safe==0(blue) values more towards the right.![](https://github.com/Note06/DataScience-Proj/blob/main/Readme/Aspose.Words.27acc061-d1be-46c8-b3d1-fed75dd6db93.017.png)
...
| Classification Accuracy | 1                     | 0.783      | 0.92                    | 0.739(0.789)    | 0.993       | 0.779(0.823) | 0.999             | 0.797(0.821) | 0.999              | 0.780(0.802)   |
| True Positive           | 676                   | 523        | 591                     | 555      | 684         | 475   | 683           | 504   | 678            | 512     |
| True Negative           | 692                   | 548        | 662                     | 456      | 675         | 591   | 684           | 586   | 689            | 555     |
| False Positive          | 0                     | 155        | 84                      | 230      | 0           | 90   | 0             | 104    | 0              | 133     |
| False Negative          | 0                     | 142        | 31                      | 127      | 9           | 212   | 1             | 174   | 1              | 168     |
